...
$id=$_POST["t1"];
$pp=$_POST["t2"];
$Query2="select count(*) from sold_pets where sd_id='$id' AND pet_id='$pp'";
$Execute = mysqli_query($conn,$Query2);
$count = mysqli_fetch_row($Execute);
if($count[0]==1)
{
    $sql = "DELETE FROM sold_pets WHERE sd_id='$id' AND pet_id='$pp'";
...
border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;"formaction="soldpets.php">back</button>
</form>
</body>
</html>